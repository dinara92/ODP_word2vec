...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec 21 15:56:10 2016
...
language = ["English","Deutsch","USA","Japanese","French","Russian","German","Hindi"]
relation = ["King","Queen","Prince","Princess","daughter","son","woman","man"]
...
# get trained model
model = gensim.models.Word2Vec.load_word2vec_format("/home/dinara/word2vec/word2vec_gensim_ODP/ODP_word2vec/GoogleNews-vectors-negative300.bin", binary=True)
# draw pca plots
#draw_words(model, currency, True, True, True, -3, 3, -2, 2, r'$PCA\ Visualisierung:\ W\ddot{a}hrung$')
#draw_words(model, capital, True, True, True, -3, 3, -2, 2.2, r'$PCA\ Visualisierung:\ Capital$')
#draw_words(model, language, True, True, True, -3, 3, -2, 1.7, r'$PCA\ Visualisierung:\ Language$')
draw_words(model, relation, True, True, True, -3, 3, -2, 1.7, r'$PCA\ Visualisierung:\ Relation$')